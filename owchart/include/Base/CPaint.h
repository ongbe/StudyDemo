...
namespace OwLib
{
	...
	static _int64 SYSTEMCOLOR_CONTROL = (_int64)-2000000001;
	static _int64 SYSTEMCOLOR_CONTROLBORDER = (_int64)-2000000002;
	static _int64 SYSTEMCOLOR_CONTROLTEXT = (_int64)-2000000003;
    static _int64 SYSTEMCOLOR_DISABLEDCONTROL = (_int64)-2000000004;
    static _int64 SYSTEMCOLOR_DISABLEDCONTROLTEXT = (_int64)-2000000005;
	static _int64 SYSTEMCOLOR_HOVEREDCONTROL = (_int64)-2000000006;
	static _int64 SYSTEMCOLOR_PUSHEDCONTROL = (_int64)-2000000007;
	static _int64 SYSTEMCOLOR_EMPTY = (_int64)-2000000000;
	...
	public:
		...
		virtual void DrawEllipse(_int64 dwPenColor, int width, int style, const RECT& rect);
		virtual void DrawEllipse(_int64 dwPenColor, int width, int style, int left, int top, int right, int bottom);
		...
		virtual void DrawLine(_int64 dwPenColor, int width, int style, const POINT& x, const POINT& y);
		virtual void DrawLine(_int64 dwPenColor, int width, int style, int x1, int y1, int x2, int y2);
		virtual void DrawPolygon(_int64 dwPenColor, int width, int style, POINT *apt, int cpt);
		virtual void DrawPolyline(_int64 dwPenColor, int width, int style, POINT *apt, int cpt);
		virtual void DrawRect(_int64 dwPenColor, int width, int style, int left, int top, int right, int bottom);
		virtual void DrawRect(_int64 dwPenColor, int width, int style, const RECT& rect);
		virtual void DrawRoundRect(_int64 dwPenColor, int width, int style, const RECT& rect, int cornerRadius);
